...
class StandardStrategy implements BonusCalculationStrategy
{
    public function calculate(Money $purchaseAmount): Points
    {
        // 1 point for every 10 currency units (1000 minor units).
        $points = (int) floor($purchaseAmount->amount / 1000);
